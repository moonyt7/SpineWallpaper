package com.spine.wallpaper.v41
...
/**
 * Isolated Spine 4.1 Runtime Adapter.
 * 使用官方 spine-libgdx 4.1.0 runtime（通过 shadow plugin 重定位到 com.spine.wallpaper.spine41）。
 */
class SpineV41Adapter(
    ...
    override val runtimeVersion: SpineVersion = SpineVersion.V41
    ...
    override fun update(deltaSeconds: Float) {
        ...
        // 4.1: updateWorldTransform 无参数（Physics 是 4.2 才引入的）
    ...
    override fun hitTest(screenX: Float, screenY: Float): String? = "v41_body"
