package com.spine.wallpaper.v40
...
/**
 * Isolated Spine 4.0 Runtime Adapter.
 * 使用官方 spine-libgdx 4.0.18.1 runtime（通过 shadow plugin 重定位到 com.spine.wallpaper.spine40）。
 */
class SpineV40Adapter(
    ...
    override val runtimeVersion: SpineVersion = SpineVersion.V40
    ...
    override fun update(deltaSeconds: Float) {
        ...
        // 4.0: updateWorldTransform 无参数（Physics 是 4.2 才引入的）
    ...
    override fun hitTest(screenX: Float, screenY: Float): String? = "v40_body"
