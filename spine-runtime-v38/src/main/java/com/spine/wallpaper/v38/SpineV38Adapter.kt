package com.spine.wallpaper.v38
...
/**
 * Isolated Spine 3.8 Runtime Adapter.
 * 使用官方 spine-libgdx 3.8.99.1 runtime（通过 shadow plugin 重定位到 com.spine.wallpaper.spine38）。
 */
class SpineV38Adapter(
    ...
    override val runtimeVersion: SpineVersion = SpineVersion.V38
    ...
    override fun update(deltaSeconds: Float) {
        ...
        // 3.8: updateWorldTransform 无参数（Physics 是 4.2 才引入的）
    ...
    override fun hitTest(screenX: Float, screenY: Float): String? = "v38_body"
